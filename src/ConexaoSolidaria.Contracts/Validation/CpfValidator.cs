...
public static partial class CpfValidator
{
    ...
    /// <summary>
    /// Mascara um CPF para exibicao/log, revelando apenas os 2 ultimos digitos: "***.***.***-NN".
    /// Nunca retorna o CPF completo. Use sempre que precisar logar ou expor um CPF.
    /// </summary>
    public static string Mask(string? cpf)
    {
        ...
        var digits = Normalize(cpf);
        var lastTwo = digits.Length >= 2 ? digits[^2..] : "**";
